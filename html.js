...
let questions = [
    {
      ...
      answer: "a) To create metadata for search engines",
      options: [
        "a) To create metadata for search engines",
        "b) To define a new paragraph",
    ...
    {
      numb: 3,
      question: "In HTML, what is the purpose of the `hr` tag?",
      answer: "c) Define a horizontal line",
      options: [
        "a) Highlight text",
        "b) Create a hyperlink",
        "c) Define a horizontal line",
        "d) Indent content"
      ]
    },
    {
      numb: 4,
      question: " Which attribute is used to specify the source URL of an `img` tag in HTML?",
      answer: "a) src",
      options: [
    ...
    {
        numb: 6,
        question: "What does the HTML attribute `colspan` define in a table cell?",
        answer: "a) <ul>",
        options:[
    ...
    },
    {
        ...
        answer:  "a) Define a division or a section in an HTML document",
        options: [
            "a) Define a division or a section in an HTML document",
            "b) Create a hyperlink",
            "c) Define an italic text",
            "d) Embed an image"
        ]
      },
        {
      ...
      },
      {
        ...
        answer: "d) Create an interactive form for user input",
        options: [
           "a) Create a hyperlink",
            "b) Define a table",
            "c) Embed an image",
